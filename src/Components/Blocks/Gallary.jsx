                        ...
                        <div className="GallaryTitle">
                            ...
                            <div className="GallaryList">
                                <ul className="GallaryListUlOne">
                                    <li onClick={() => this.setState({ tabSelected: 1 })}>All</li>
                                    <li onClick={() => this.setState({ tabSelected: 1 })}>Showrooms</li>
                                    <li onClick={() => this.setState({ tabSelected: 1 })}>Social Responsibliity</li>
                                    <li onClick={() => this.setState({ tabSelected: 1 })}>Events </li>
                                    <li onClick={() => this.setState({ tabSelected: 1 })}>Company </li>
                                    <li onClick={() => this.setState({ tabSelected: 1 })}>Videos </li>
                                </ul>
